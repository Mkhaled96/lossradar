...
export default function ComplaintsPage() {
  return (
    <AdminLayout>
      ...
      `}</style>
      <h1 className="ph-title">Complaints</h1>
      <div className="ph-card">
        <p className="ph-text">نظام متابعة الشكاوى (Pending / Resolved / Escalated) — محتاج جدول جديد (complaints) هنضيفه في الخطوة الجاية.</p>
      </div>
    </AdminLayout>
  );
}
