...
export default function FinancePage() {
  return (
    <AdminLayout>
      ...
      `}</style>
      <h1 className="ph-title">Finance</h1>
      <div className="ph-card">
        <p className="ph-text">حسابات ومدفوعات العملاء — لسه محتاجين نحدد الهيكل بالظبط (اشتراك شهري؟ حسب عدد المركبات؟) قبل ما نبنيها.</p>
      </div>
    </AdminLayout>
  );
}
